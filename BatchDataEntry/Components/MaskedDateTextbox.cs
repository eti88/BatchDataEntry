...
{
    public class MaskedDateTextbox : TextBox
    {
        ...
        static MaskedDateTextbox()
        {
            TextProperty.OverrideMetadata(typeof(MaskedDateTextbox),
                new FrameworkPropertyMetadata(null, new CoerceValueCallback(Text_CoerceValue)));
            InputMaskProperty = DependencyProperty.Register("InputMask", typeof(string), typeof(MaskedDateTextbox),
        ...
        {
            MaskedDateTextbox mtb = (MaskedDateTextbox)obj;
        ...
        {
            (obj as MaskedDateTextbox).UpdateInputMask();
        }
